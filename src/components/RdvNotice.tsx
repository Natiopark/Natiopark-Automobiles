...
export function RdvNotice() {
  return (
    <section className="section-pad py-16">
      <Reveal>
        <div className="relative mx-auto max-w-7xl overflow-hidden rounded-sm border border-forest-light/30 bg-gradient-to-br from-forest/40 via-charcoal-deep to-charcoal-deep px-8 py-12 md:px-14 md:py-16">
